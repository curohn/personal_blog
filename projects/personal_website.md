...
- **Murmuration**: Controls panel for the live boid flocking simulation running in the background. Adjust separation, alignment, cohesion weights and radii to shape the flock visible across every page. [Try it →](/projects/murmuration)
